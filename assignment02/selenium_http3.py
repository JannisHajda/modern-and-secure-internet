...
RESULTS_FILE = "./selenium_http3_results.csv"
ERRORS_FILE = "./selenium_http3_errors.csv"
...
def process_url(row):
    ...
    options.add_argument('--enable-features=EnableHttp3')
    options.add_argument(f'--origin-to-force-quic-on={origin}')
